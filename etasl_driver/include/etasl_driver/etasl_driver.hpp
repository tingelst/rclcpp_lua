...
#ifndef ETASL_DRIVER__ETASL_DRIVER_HPP_
#define ETASL_DRIVER__ETASL_DRIVER_HPP_
...
class EtaslDriver
{
  std::shared_ptr<qpOASESSolver> solver_;
  bool etaslread;
  bool initialized_;
  std::shared_ptr<Context> ctx_;
  std::shared_ptr<LuaContext> lua_;
  std::shared_ptr<Observer> obs_;
  std::shared_ptr<OutputGenerator> out_;
...
#endif  // ETASL_DRIVER__ETASL_DRIVER_HPP_
